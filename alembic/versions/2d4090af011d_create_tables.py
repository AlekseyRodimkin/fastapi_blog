...
Revision ID: 2d4090af011d
Revises:
Create Date: 2025-04-09 03:12:06.079445
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="tweets_user_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tweet_id"], ["tweets.id"], name="media_tweet_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tweet_id"], ["tweets.id"], name="likes_tweet_id_fkey", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
